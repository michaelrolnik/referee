 ...
 */
//  Generated by `referee header` from test/logic/extfunc.ref at build time.
//  It supplies the types *and* the aliases that map each plain name to the
//  hashed symbol, so nothing below has to know the hash exists.
#include "extfunc_gen.h"
