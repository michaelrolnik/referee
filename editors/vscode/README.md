...
It also does **completion** (a bare identifier offers the names in scope — signals,
confs, types, functions — plus keywords; after a `.` it narrows to the type's fields
or enum cases), **hover** (point at a name to see its
